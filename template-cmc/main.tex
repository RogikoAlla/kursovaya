...
\Year{2026}
  ...
  \TitleTop{Исследование и реализация жадных алгоритмов \\ для задачи распределения \\ таблиц классификации по стадиям конвейера СПУ}
  \TitleBottom{}
...
%\include{Chapter5} — архитектура в конце Chapter4 (sec:arch-software)
